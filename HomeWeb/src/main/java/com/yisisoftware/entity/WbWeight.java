...
public class WbWeight implements java.io.Serializable {
	...
	/** minimal constructor */
	public WbWeight(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public WbWeight(Integer id, String outBillNo, String contractBillNo,
			String cars, String carsTeam, String carsType, String supply,
			String customer, String drivers, String material,
			String materialKind, String trafficCompany, String store,
			String weightNo, String lightNo, Date weightDate,
			Date lightDate, Date createDate, Date printDate,
			Date updateDate, Date deleteDate, Double yfgross,
			Double yftare, Double yfsuttle, Double gross, Double tare,
			Double suttle, Double fbgross, Double fbtare, Double fbsuttle,
			Double handGross, Double handTare, Double handSuttle,
			Double inCimpurity, Double inCwater, Double inCweight,
			Double outCimpurity, Double outCwater, Double outCweight,
			Double price, Double charge, Double taxPrice, Double taxCharge,
			Double trafficPrice, Double trafficCharge, Double loadPrice,
			Double loadCharge, Double weightPrice, Double weightCharge,
			String loadCars, String loadUser, String loadAddress,
			String inGbuser, String inDbuser, String outGbuser,
			String outDbuser, Integer printCount, Short type,
			...
			String reservationList2, String reservationList3, String picture,
			...
			String reservationChar12, Integer sstatus, Integer fstatus) {
		this.id = id;
	...
	@Column(name = "ReservationList3", length = 50)
