...
/**
 * WbCustomerReceipt entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "WB_CustomerReceipt")
public class WbCustomerReceipt implements java.io.Serializable {

	// Fields

	private String billNo;
	private Integer id;
	private String weightBillNo;
	...
	/** default constructor */
	public WbCustomerReceipt() {
	}

	/** minimal constructor */
	public WbCustomerReceipt(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public WbCustomerReceipt(Integer id, String weightBillNo,
			...
			String store, String weightNo, String lightNo,
			Date weightDate, Date lightDate, Date createDate,
			Date printDate, Date updateDate, Date deleteDate,
			Double yfgross, Double yftare, Double yfsuttle, Double gross,
			Double tare, Double suttle, Double fbgross, Double fbtare,
			Double fbsuttle, Double handGross, Double handTare,
			...
			Short test, Short finish) {
		this.id = id;
		this.weightBillNo = weightBillNo;
	...
	// Property accessors
	@Id
	@Column(name = "BillNO", unique = true, nullable = false, length = 36)
	...
	@Column(name = "WeightBillNO", length = 36)
	public String getWeightBillNo() {
		return this.weightBillNo;
	}

	public void setWeightBillNo(String weightBillNo) {
		this.weightBillNo = weightBillNo;
	}
